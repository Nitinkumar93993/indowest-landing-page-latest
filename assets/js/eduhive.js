  ...
  function thmOwlInit() {
    ...
    if (eduhiveowlCarousel.length) {
      eduhiveowlCarousel.each(function () {
        ...
        // Modify options to include autoplaySpeed
        ...
        // Set aria-label for buttons inside the carousel
        elm.find("button").each(function () {
          $(this).attr("aria-label", "carousel button");
        });
      });
    ...
    let eduhiveowlCarouselWithFilterWithCounter = $(
      ".eduhive-owl__carousel--filter-with-counter"
    );
